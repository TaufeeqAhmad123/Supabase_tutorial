...
6. copy this command to cmd "keytool -exportcert -alias androiddebugkey -keystore "%USERPROFILE%\.android\debug.keystore" -storepass android -keypass android | "C:\Program Files\openssl\bin\openssl.exe" sha1 -binary | "C:\Program Files\openssl\bin\openssl.exe" base64" and paste it in cmd and copy the output
